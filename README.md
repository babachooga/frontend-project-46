...
[![hexlet-check](https://github.com/babachooga/frontend-project-46/actions/workflows/hexlet-check.yml/badge.svg)](https://github.com/babachooga/frontend-project-46/actions)
...
```bash
git clone https://github.com/babachooga/frontend-project-46.git
